    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="bg-white border border-phx-border shadow-sm p-4 mb-6 flex flex-wrap gap-4 items-center rounded-lg no-print">
        ...
        <div className="flex-1 min-w-[240px]">
          <strong className="text-sm text-phx-red block">Certificate Generation via CLI</strong>
        ...
        <button
          onClick={() => copyToClipboard(`python -m backend.reporting.certificate_draft case_store/${id}/run/custody_facts.json --out certificate_output/${id}`)}
